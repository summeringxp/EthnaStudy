...
// Pear and Smarty Path
ini_set('include_path', '/usr/local/pear/share/pear' . PATH_SEPARATOR . dirname(BASE) . '/libs' );
...
require_once 'Test_ActionClass.php';
require_once 'Test_ActionForm.php';
require_once 'Test_ViewClass.php';
require_once 'Test_UrlHandler.php';
include_once('Test_Error.php');
include_once('Test_User.php');

/**
 *  Test application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Test
 */
class Test_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Test_View_Index',
         *  ),
         */
       'login' => array(
       'view_name' => 'Test_View_Login',
        'forward_path' => 'login.tpl'
        ),
    	'regist' => array(
    				'view_name' => 'Test_View_Regist',
    				'forward_path' => 'regist.tpl'
    		)
    );
    ...
    protected $action = array(
         ...
         */
    		'login'  => array(
              'class_name' => 'Test_Action_Login'
			),
    		'regist'  => array(
    				'class_name' => 'Test_Action_Regist'
    		)
    );
